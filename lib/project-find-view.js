...
module.exports = class ProjectFindView {
  constructor(
    ...
    this.subscriptions.add(
      lumine.textEditors.add(this.refs.findEditor),
      lumine.textEditors.add(this.refs.replaceEditor),
      lumine.textEditors.add(this.refs.pathsEditor),
  ...
  updateSyntaxHighlighting() {
    if (this.model.getFindOptions().useRegex) {
      this.findEditor.setGrammar(lumine.grammars.grammarForScopeName("source.js.regexp"));
      return this.replaceEditor.setGrammar(
        lumine.grammars.grammarForScopeName("source.js.regexp.replacement"),
      );
    } else {
