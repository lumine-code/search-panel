...
module.exports = class ProjectFindView {
  ...
  updateSyntaxHighlighting() {
    if (this.model.getFindOptions().useRegex) {
      ...
      if (!lumine.grammars.assignLanguageMode(this.findEditor, "text.plain")) {
        lumine.grammars.assignLanguageMode(this.findEditor, null);
      }
      if (!lumine.grammars.assignLanguageMode(this.replaceEditor, "text.plain")) {
        return lumine.grammars.assignLanguageMode(this.replaceEditor, null);
      }
    }
  }
